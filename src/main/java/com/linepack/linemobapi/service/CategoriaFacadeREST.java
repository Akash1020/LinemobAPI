...
import com.linepack.linemobapi.model.Categoria;
...
public class CategoriaFacadeREST extends AbstractFacade<Categoria> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Categoria entity) {
        super.edit(entity);
    }
    ...
    public Categoria find(@PathParam("id") BigDecimal id) {
